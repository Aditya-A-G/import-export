  ...
  return (
    <section className="w-full flex flex-col justify-center items-center py-10">
      ...
      <div className="w-2/3 md:w-7/12 lg:w-2/5 flex flex-col md:flex-row gap-7 mt-10">
        <button className="w-full bg-black text-white py-9 md:py-8  lg:py-9 font-bold hover:bg-[#4DAEC2]">BECOME A SUPPLIER</button>
        <button className="w-full bg-black text-white py-9 md:py-8 lg:py-9 font-bold hover:bg-[#4DAEC2]">BECOME A CUSTOMER</button>
      </div>
    </section>
  );
};
